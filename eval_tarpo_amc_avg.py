...
def generate_and_save_trajectories(
    ...
    print(f"Loading AMC dataset from: {data_path}")
...
def evaluate_saved_trajectories(jsonl_path: str, k: int, output_dir: str):
    ...
    print("\n" + "="*50)
    print("🎯 TARPO AMC EVALUATION SUMMARY")
    print("="*50)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, required=True, help="Path to amc23.json")
    parser.add_argument("--k", type=int, default=32, help="Number of samples per question")
    parser.add_argument("--batch_size", type=int, default=2, help="Batch size (actual = batch_size * k)")
    ...
    eval_dir = f"{checkpoint_path}/eval_amc23_k{args.k}_batch{args.batch_size}_{max_new_tokens}"
